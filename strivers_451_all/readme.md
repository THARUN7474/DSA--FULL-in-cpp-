...
1. **Revision Before Solving**  
   - Before solving new problems, I will **review the previous day’s completed problems**, including:  
     - The code I wrote.  
...
2. **Solving Process**  
   ...
   - **Store all solutions locally on my laptop** and push them to **GitHub** after completing the day’s problems.  
...
|------|-----------------|----------------|------------|  
| **Step 3** | **Solve Problems on Arrays (Easy → Medium → Hard)** | **40** | **14 / 40** |  
| **Lec 1** | Easy | **14** | **14 / 14** |  
